...
import {
  anuleazaCursa, corecteazaStarea, mutaCursa, salveazaCursa, schimbaStareaCursei, seteazaStarePerioada,
...
export default function BandaClient({ zile, camioane, curse, stari, puncte, soferi, taiat, poateEdita }: Props) {
  ...
  return (
    <div className="page">
      ...
      {!form && mesaje}
      {/* Panoul «Automatul n-a putut decide» a fost scos pe 21.09 (Ion: «nu trebuie
          alerte»; «trebuie programul să ruleze și să înțeleagă starea automat, asta
          tot»). Automatul nu mai cere nimănui nimic; ce hotărăște singur scrie în
          nota cursei, acolo se citește. */}
      {taiat && (
