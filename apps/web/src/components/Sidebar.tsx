...
const nav: NavItem[] = [
  ...
  { href: '/fb-bot',       label: 'Bot Facebook',  adminOnly: true,  icon: 'M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H5.17L4 17.17V4h16v12zM7 9h2v2H7zm4 0h2v2h-2zm4 0h2v2h-2z' },
