  ...
  return (
    <>
      <div className="page-header">
        <h1>Căutare piesă</h1>
        <p>Pentru când clientul nu știe codul: caută după denumire, categorie, articul, OEM sau scanează codul de bare. Vezi denumirea corectă, dacă o avem în stoc și unde, iar dacă nu — de la ce furnizor și la ce preț.</p>
      </div>
      <CautareClient categories={categories} />
    </>
  );
}
