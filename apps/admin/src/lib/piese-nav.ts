...
const PIESE_HREFS_BY_ROLE: Partial<Record<AdminRole, Set<string>>> = {
  ...
  VINZATOR: new Set(['/piese', '/piese/stoc', '/piese/catalog', '/piese/nomenclator', '/piese/rashod', '/piese/mutari', '/piese/inventar', '/piese/magazin', '/piese/fiscal', '/piese/harta', '/piese/rapoarte']),
  // DEPOZITAR — intrări (prihod), inventariere, nomenclator (furnizori); vede „de comandat"/stoc.
  DEPOZITAR: new Set(['/piese', '/piese/stoc', '/piese/catalog', '/piese/nomenclator', '/piese/prihod', '/piese/inventar', '/piese/harta', '/piese/rapoarte']),
  // CONTABIL — doar citire pe documente + rapoarte + e-Factura/1C (export).
  CONTABIL: new Set(['/piese', '/piese/stoc', '/piese/catalog', '/piese/harta', '/piese/rapoarte', '/piese/fiscal', '/piese/integrare-1c']),
