  ...
  return (
    <>
      ...
      <div className="grid cols-2">
        {showCost && (
        <CollapsibleCard title="Top mașini după cost piese" storageKey="cost-vehicle">
          <table>
        ...
        <CollapsibleCard title="⚠ Перерасход (aceeași piesă, prea des)" storageKey="overconsumption">
        ...
        <CollapsibleCard title="Fiabilitate pe producători" storageKey="reliability">
        ...
        <CollapsibleCard title="De comandat (stoc minim)" storageKey="low-stock">
      ...
      <CollapsibleCard title="Неликвид — fără mișcare de mult" storageKey="illiquid">
      ...
      <CollapsibleCard title="Mișcarea stocului (jurnal)" storageKey="ledger">
        <table>
