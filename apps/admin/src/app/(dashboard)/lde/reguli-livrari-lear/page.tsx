// Reguli livrări LEAR — catalogul regulilor, în «Nomenclator LDE» (Ion, 24.09.2026, ION-50).
...
export default async function ReguliLivrariLearPage() {
  ...
  if (!r.text) {
    return (
      <div className="p-6 max-w-5xl space-y-2">
        <h1 className="text-2xl font-semibold">Reguli livrări LEAR</h1>
